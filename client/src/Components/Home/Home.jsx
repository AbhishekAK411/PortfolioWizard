    ...
    return (
        <>
            ...
            <main className="cursor-gray w-full min-h-screen">
                <section className="w-full h-[660px] bg-center bg-no-repeat bg-cover bg-[url('Images/18262593_5968949.jpg')] flex justify-around items-center">
                    <section className="w-[53%] h-[90%] flex items-center justify-center">
                        <div className="w-[60%] h-[80%] flex flex-col gap-y-2 ">
                            ...
                            <div className="w-full h-[20%] flex">
                                ...
                                <p className="text-[#673AB7] text-6xl font-bold ml-5 whitespace-nowrap"><Typewriter options={{autoStart: true, loop: true}} onInit={(typewriter) => typewriter.typeString('Developer').pauseFor(1000).deleteAll().typeString('Linux Administrator').pauseFor(1000).deleteAll().typeString('Coder').pauseFor(1000).deleteAll().typeString('Experienced').pauseFor(1000).start()} /></p>
                            </div>
